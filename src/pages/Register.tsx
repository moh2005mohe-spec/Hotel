    ...
    <div className="min-h-[calc(100vh-4rem)] flex items-center justify-center px-4 py-12">
      <div className="w-full max-w-md">
        <div className="card p-8 animate-scale-in">
          ...
          {!success && <p className="text-center text-sm text-neutral-600 mt-6">{t('auth.have_account')} <Link to="/login" className="text-primary-700 font-medium hover:underline">{t('auth.login_link')}</Link></p>}
        </div>
      </div>
    </div>
  )
